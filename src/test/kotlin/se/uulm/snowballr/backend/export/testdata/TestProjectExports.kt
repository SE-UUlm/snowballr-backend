...
val fullProjectExport = ProjectExport(
    name = "Full Project",
    members = listOf(
        ProjectMemberExport("1", "Alice", "Smith", "alice.smith@example.com", MemberRole.DEFAULT),
        ProjectMemberExport("2", "John", "Doe", "john.doe@example.com", MemberRole.DEFAULT),
        ProjectMemberExport("3", "Jane", "Doe", "jane.doe@example.com", MemberRole.ADMIN),
    ),
    stages = listOf(
        ProjectStageExport(
            "1",
            papers = listOf(
                PaperExport(
                    ...
                    reviews = listOf(
                        PaperReviewExport("1", ReviewDecision.ACCEPTED, listOf("0")),
                        PaperReviewExport("2", ReviewDecision.DECLINED, listOf("1")),
                        PaperReviewExport("3", ReviewDecision.ACCEPTED, listOf("2")),
                    ),
                ...
                PaperExport(
                    ...
                    reviews = listOf(
                        PaperReviewExport("1", ReviewDecision.ACCEPTED, listOf("0")),
                        PaperReviewExport("2", ReviewDecision.ACCEPTED, listOf("1")),
                        PaperReviewExport("3", ReviewDecision.ACCEPTED, listOf("2")),
                    ),
                    finalDecision = PaperDecision.ACCEPTED,
                    createdAt = "2023-03-15T10:00:00Z",
        ...
        ProjectStageExport(
            ...
            papers = listOf(
                ...
                PaperExport(
                    ...
                    reviews = listOf(
                        PaperReviewExport("1", ReviewDecision.DECLINED, listOf("0")),
                        PaperReviewExport("2", ReviewDecision.DECLINED, listOf("1")),
                        PaperReviewExport("3", ReviewDecision.DECLINED, listOf("2")),
                    ),
        ...
        ProjectStageExport(
            ...
            papers = listOf(
                ...
                PaperExport(
                    ...
                    reviews = listOf(
                        PaperReviewExport("1", ReviewDecision.MAYBE, listOf("0")),
                        PaperReviewExport("2", ReviewDecision.DECLINED, listOf("1")),
                    ),
                    finalDecision = PaperDecision.DECLINED,
                    createdAt = "2023-03-15T10:00:00Z",
