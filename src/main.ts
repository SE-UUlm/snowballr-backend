...
import {
  validateContentType,
  validateJWTIfExists,
} from "./controller/validation.controller.ts";
...
import {
  ...
  postPaperCitation,
  postPaperReference,
} from "./controller/paper.controller.ts";
import {
  deleteSourceAuthor,
  getAuthor,
  getSourceAuthor,
...
router
  ...
  .get("/projects/:id/stages/:id2/papers", async (context) => {
    await getPapersOfProjectStageFast(
      context,
      Number(context.params.id),
      Number(context.params.id2),
    );
  ...
  .get("/projects/:id/stages/:id2/papers/:ppid", async (context) => {
    await getPaperOfProjectStage(
      context,
      Number(context.params.id),
      Number(context.params.id2),
      Number(context.params.ppid),
    );
  })
  .patch("/projects/:id/stages/:id2/papers/:ppid", async (context) => {
    await patchPaperOfProjectStage(
      context,
      Number(context.params.id),
      Number(context.params.id2),
      Number(context.params.ppid),
  ...
  .post(
    "/projects/:id/stages/:id2/papers/:ppid/references",
    async (context) => {
  ...
  .get(
    "/projects/:id/stages/:id2/papers/:ppid/reviews/:rid",
    async (context) => {
  ...
  .get(
    "/projects/:id/stages/:id2/papers/:ppid/reviews/:rid/criteriaevaluations",
    async (context) => {
  ...
  .get(
    "/projects/:id/stages/:id2/papers/:ppid/reviews/:rid/criteriaevaluations/:cid",
    async (context) => {
