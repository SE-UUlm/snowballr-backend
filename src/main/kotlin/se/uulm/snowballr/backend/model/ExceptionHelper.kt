...
/**
 * Constructs a formatted string representation of the provided entity IDs, incorporating an optional identifier type
 * for contextualizing the IDs.
 *
 ...
 * @return A string containing the formatted representation of the entity IDs prefixed with the specified identifier
 * type.
 */
