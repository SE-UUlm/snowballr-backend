export const headers = {
  "alt-svc":
    'h3=":443"; ma=2592000,h3-29=":443"; ma=2592000,h3-Q050=":443"; ma=2592000,h3-Q046=":443"; ma=2592000...',
  ...
  server: "scholar",
  "set-cookie":
    "GSP=LM=1634716931:S=F8wDH2CGyMndoBqK; expires=Fri, 20-Oct-2023 08:02:11 GMT; path=/; domain=scholar....",
...
export const paperResponse: string = Deno.readTextFileSync(
  `${new URL(".", import.meta.url).pathname}/googleScholarHtmlMock1.txt`,
);

export const citationResponse: string = Deno.readTextFileSync(
  `${new URL(".", import.meta.url).pathname}/googleScholarHtmlMock2.txt`,
);

export const captchaResponse: string = Deno.readTextFileSync(
  `${new URL(".", import.meta.url).pathname}/googleScholarHtmlMock3.txt`,
);

export const parsedPaperNoCites = {
  "id": undefined,
  "title": [
  ...
  "numberOfCitations": [0],
  "year": [2009],
  "publisher": ["2009 35th Euromicro Conference on Software …"],
  "type": [],
  "scope": [],
  "scopeName": [],
  "pdf": [],
