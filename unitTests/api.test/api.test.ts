...
export const standardPaper: IApiPaper = {
  title: [],
  abstract: [],
  author: [],
  year: [],
...
Deno.test({
  ...
  async fn(): Promise<void> {
    ...
    const firstPaper = {} as IApiPaper;
    const secondPaper = {} as IApiPaper;
    Object.assign(firstPaper, standardPaper);
    Object.assign(firstPaper, {
      "title": ["awsome paper title"],
      "author": [{
        "orcid": [],
        "rawString": ["samuel idowu"],
        "lastName": [],
        "firstName": [],
      }, {
        "orcid": [],
        "rawString": ["max muster"],
        "lastName": ["Muster"],
        "firstName": ["Max"],
      }],
    });
    Object.assign(secondPaper, standardPaper);
    Object.assign(secondPaper, {
      "title": ["awsome paper title"],
      "author": [{
        "orcid": [],
        "rawString": ["Samuel Idowu"],
    ...
    const firstApiResponseJustTitle: IApiResponse = {
      paper: firstPaper,
      citations: [],
      references: [],
    };
    const secondApiResponseJustTitle: IApiResponse = {
      paper: secondPaper,
      citations: [],
      references: [],
    };
    const merged = await apiMerger.compare([
      makePromise<IApiResponse>(firstApiResponseJustTitle),
      makePromise<IApiResponse>(secondApiResponseJustTitle),
    ]);
...
Deno.test({
  ...
  async fn(): Promise<void> {
    ...
    const firstPaper = {} as IApiPaper;
    const secondPaper = {} as IApiPaper;
    const thirdPaper = {} as IApiPaper;

    Object.assign(firstPaper, standardPaper);
    Object.assign(firstPaper, {
      "title": ["awsome paper title"],
      "abstract": ["one good abstract"],
      "author": [{
        "id": [],
        "orcid": [],
        "rawString": ["samuel idowu"],
    ...
    const thirdApiResponseJustTitle: IApiResponse = {
      paper: thirdPaper,
      citations: [],
      references: [],
    };
...
Deno.test({
  ...
  async fn(): Promise<void> {
    ...
    const secondPaper = {} as IApiPaper;
    const thirdPaper = {} as IApiPaper;
    const fourthPaper = {} as IApiPaper;
    Object.assign(firstPaper, standardPaper);
    Object.assign(firstPaper, {
      "title": ["awsome paper title"],
      "abstract": ["one good abstract"],
    ...
    const fourthApiResponseJustTitle: IApiResponse = {
      paper: fourthPaper,
      citations: [],
      references: [],
    };
...
Deno.test({
  ...
  async fn(): Promise<void> {
    ...
    Object.assign(firstPaper, standardPaper);
    Object.assign(firstPaper, {
      title: ["I am a Great-Paper"],
      abstract: ["i am the abstract of the light side"],
    });
    Object.assign(secondPaper, standardPaper);
    Object.assign(secondPaper, { title: ["i am a great paper"] });
    Object.assign(thirdPaper, standardPaper);
    ...
    assertEquals(merged.length, 1);
    assertEquals(merged[0].paper.title, ["I am a Great-Paper"]);
    assertEquals(merged[0].paper.abstract, [
      "i am the abstract of the light side",
    ]);
  },
});
...
Deno.test({
  ...
  async fn(): Promise<void> {
    ...
    const thirdPaper = {} as IApiPaper;
    const fourthPaper = {} as IApiPaper;
    const fifthPaper = {} as IApiPaper;
    const sixthPaper = {} as IApiPaper;
    Object.assign(firstPaper, standardPaper);
    ...
    Object.assign(fifthPaper, {
      title: ["General Kenobi"],
      abstract: ["I am the Abstract: of the Light Side"],
    });
    Object.assign(sixthPaper, standardPaper);
    Object.assign(sixthPaper, {
      title: ["general kenobi"],
      abstract: ["I am the Abstract: of the Light Side"],
    });
    ...
    const firstApiResponseJustTitle: IApiResponse = {
      paper: firstPaper,
      citations: [thirdPaper, fourthPaper],
      references: [],
    };
    const secondApiResponseJustTitle: IApiResponse = {
      paper: secondPaper,
      citations: [fifthPaper, sixthPaper],
      references: [],
    };
...
Deno.test({
  ...
  async fn(): Promise<void> {
    ...
    const firstApiResponseJustTitle: IApiResponse = {
      paper: firstPaper,
      citations: [],
      references: [thirdPaper, fourthPaper],
    };
    const secondApiResponseJustTitle: IApiResponse = {
      paper: secondPaper,
      citations: [],
      references: [fifthPaper, sixthPaper],
    };
...
Deno.test({
  ...
  async fn(): Promise<void> {
    ...
    Object.assign(firstPaper, standardPaper);
    Object.assign(firstPaper, {
      uniqueId: [{ type: idType.DOI, value: "1234" }],
      title: ["I am a Great Paper"],
      source: ["MA"],
    });
    Object.assign(secondPaper, standardPaper);
    ...
    assertEquals(merged.length, 1);
    assertEquals(merged[0].paper.title, [
      "I am a Great Paper",
      "I am a different Title",
    ]);
...
Deno.test({
  ...
  async fn(): Promise<void> {
    ...
    Object.assign(thirdPaper, {
      uniqueId: [{ type: idType.DOI, value: "1234" }],
      title: ["I am a very different-Title"],
      source: ["CA"],
    });
...
Deno.test({
  ...
  async fn(): Promise<void> {
    ...
    const fifthPaper = {} as IApiPaper;
    const sixthPaper = {} as IApiPaper;
    const seventhPaper = {} as IApiPaper;
    const eighthPaper = {} as IApiPaper;
    const ninethPaper = {} as IApiPaper;
    Object.assign(firstPaper, standardPaper);
    Object.assign(firstPaper, {
      uniqueId: [{ type: idType.DOI, value: "1234" }],
      title: [],
    ...
    const fifthApiResponseJustTitle: IApiResponse = {
      paper: fifthPaper,
      citations: [],
      references: [],
    };
    const sixthApiResponseJustTitle: IApiResponse = {
      paper: sixthPaper,
      citations: [],
      references: [],
    };
    const seventhApiResponseJustTitle: IApiResponse = {
      paper: seventhPaper,
      citations: [],
      references: [],
    };
    const eighthApiResponseJustTitle: IApiResponse = {
      paper: eighthPaper,
      citations: [],
      references: [],
    };
    const ninethApiResponseJustTitle: IApiResponse = {
      paper: ninethPaper,
      citations: [],
      references: [],
    };
    ...
    assertEquals(merged[0].paper.titleSource, [["B3", "B5", "B6", "B9"], [
      "B2",
      "B4",
      "B7",
    ]]);
...
Deno.test({
  ...
  async fn(): Promise<void> {
    ...
    assertEquals(merged[0].paper.yearSource, [
      ["B1", "B3", "B5", "B7"],
      ["B2"],
      ["B6", "B8"],
    ]);
