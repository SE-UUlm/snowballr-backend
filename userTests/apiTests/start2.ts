...
for (let i = 0; i < 1; i++) {
	const query: IApiQuery = {
		...
		doi: TestDoi[i],
		title: undefined,
		enabledApis: [[SourceApi.GS]], //"luca999@web.de"], [SourceApi.IE, "4yk5d9an52ejynjsmzqxe62r"], [SourceApi.MA, "9a02225751354cd29397eba3f5382101"], [SourceApi.OC], [SourceApi.S2], [SourceApi.GS]],
